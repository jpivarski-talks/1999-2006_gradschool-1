...
// Module:      SubcollectionCuts_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor SubcollectionCuts:
//              creates a new SubcollectionCuts instance each time 
