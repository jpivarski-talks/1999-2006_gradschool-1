...
// $Id: HIFitHelix.cc,v 1.10 2002/04/27 17:02:01 cleo3 Exp $
//
// Revision history
//
// $Log: HIFitHelix.cc,v $
// Revision 1.10  2002/04/27 17:02:01  cleo3
// Have the compiler write the copy constructor, destructor and assignment operator.  Now holds a vector rather than a pointer to a vector.
//
...
static const char* const kIdString  = "$Id: HIFitHelix.cc,v 1.10 2002/04/27 17:02:01 cleo3 Exp $";
...
{
   STL_VECTOR( HitAndLinkData )::const_iterator hitItr = m_hitsOnTrack.begin() ;
   STL_VECTOR( HitAndLinkData )::const_iterator hitEnd = m_hitsOnTrack.end() ;
