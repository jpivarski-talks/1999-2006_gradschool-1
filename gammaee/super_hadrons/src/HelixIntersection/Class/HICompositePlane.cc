...
// $Id: HICompositePlane.cc,v 1.8 2002/03/13 19:49:09 wsun Exp $
//
// Revision history
//
// $Log: HICompositePlane.cc,v $
// Revision 1.8  2002/03/13 19:49:09  wsun
// Widened road for attemptHelixPropagation().
//
...
static const char* const kIdString  = "$Id: HICompositePlane.cc,v 1.8 2002/03/13 19:49:09 wsun Exp $";
				  ...
				  KTMoveControl::MoveDirection aDirection )
{
   ...
   if( bestSurface != 0 )
   {
	  ...
	  fabs( 2.*bestArcLength*bestArcLength*helixToPropagate.curvature() ) )
      {
