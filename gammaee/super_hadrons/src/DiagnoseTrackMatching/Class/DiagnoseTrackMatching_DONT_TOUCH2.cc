...
// Module:      DiagnoseTrackMatching_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor DiagnoseTrackMatching:
//              creates a new DiagnoseTrackMatching instance each time 
...
makeProcessor( void )
{
   return new DiagnoseTrackMatching;
}
