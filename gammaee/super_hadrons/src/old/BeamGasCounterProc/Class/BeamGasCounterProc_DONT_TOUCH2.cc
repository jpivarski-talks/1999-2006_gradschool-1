...
// Module:      BeamGasCounterProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor BeamGasCounterProc:
//              creates a new BeamGasCounterProc instance each time 
