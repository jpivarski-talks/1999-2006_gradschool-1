...
// $Id: KalmanHelixFitProxy.cc,v 1.3 2002/06/17 20:01:01 cleo3 Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanHelixFitProxy.cc,v 1.3 2002/06/17 20:01:01 cleo3 Exp $";
...
template < DBCandidate::Hypo H >
#endif
const typename KalmanHelixFitProxy< H >::value_type*
