...
// $Id: KalmanCandidateQualityProxy.cc,v 1.9 2002/06/12 20:31:09 cleo3 Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanCandidateQualityProxy.cc,v 1.9 2002/06/12 20:31:09 cleo3 Exp $";
static const char* const kTagString = "$Name: v02_02_00 $";
   ...
   for( ; helixItr != helixEnd ; ++helixItr )
   {
	 ...
	 if( linkData->used() )
	 {
	    ...
	    if( type == CalibratedHit::DR )
	    {
		 ...
		 reinterpret_cast<const CalibratedDRHit*>(
	    ...
	    else if( type == CalibratedHit::SVR )
	    {
		  ...
		  reinterpret_cast<const CalibratedSVHit*> (
					      hitItr->calibratedHit()) ;
