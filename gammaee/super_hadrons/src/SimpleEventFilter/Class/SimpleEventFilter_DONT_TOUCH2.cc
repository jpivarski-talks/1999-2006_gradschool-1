...
// Module:      SimpleEventFilter_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor SimpleEventFilter:
//              creates a new SimpleEventFilter instance each time 
