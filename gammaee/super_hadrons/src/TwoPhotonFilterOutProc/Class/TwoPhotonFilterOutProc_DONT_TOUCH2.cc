...
// Module:      TwoPhotonFilterOutProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor TwoPhotonFilterOutProc:
//              creates a new TwoPhotonFilterOutProc instance each time 
...
makeProcessor( void )
{
   return new TwoPhotonFilterOutProc;
}
