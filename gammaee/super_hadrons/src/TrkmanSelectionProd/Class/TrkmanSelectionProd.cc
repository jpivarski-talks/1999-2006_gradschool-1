...
// $Id: TrkmanSelectionProd.cc,v 1.1.1.1 2002/11/04 18:18:55 nea9 Exp $
//
// Revision history
//
// $Log: TrkmanSelectionProd.cc,v $
...
static const char* const kIdString  = "$Id: TrkmanSelectionProd.cc,v 1.1.1.1 2002/11/04 18:18:55 nea9 Exp $";
