...
// Module:      TrackShowerEfficiency_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor TrackShowerEfficiency:
//              creates a new TrackShowerEfficiency instance each time 
...
makeProcessor( void )
{
   return new TrackShowerEfficiency;
}
