...
// Module:      TriggerSimulator_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor TriggerSimulator:
//              creates a new TriggerSimulator instance each time 
