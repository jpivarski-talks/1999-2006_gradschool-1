...
($1<=9.44){ conts++; conten += $1; weight = 1./$3/$3; contx += $2*weight; contsig += weight; }

($1>9.44 && $1<9.459){ print $0 };

($1>=9.459 && $1<=9.462){ peaks++; peaken += $1; weight = 1./$3/$3; peakx += $2*weight; peaksig += weight; }

($1>9.462 && $1<9.52){ print $0 };

($1>=9.52){ highs++; highen += $1; weight = 1./$3/$3; highx += $2*weight; highsig += weight; }
