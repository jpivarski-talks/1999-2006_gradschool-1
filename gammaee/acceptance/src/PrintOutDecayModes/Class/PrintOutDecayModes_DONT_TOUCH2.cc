...
// Module:      PrintOutDecayModes_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor PrintOutDecayModes:
//              creates a new PrintOutDecayModes instance each time 
