...
// Module:      GetWayOutEvents_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor GetWayOutEvents:
//              creates a new GetWayOutEvents instance each time 
