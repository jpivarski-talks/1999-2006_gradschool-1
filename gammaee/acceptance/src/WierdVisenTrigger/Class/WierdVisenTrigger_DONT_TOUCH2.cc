...
// Module:      WierdVisenTrigger_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor WierdVisenTrigger:
//              creates a new WierdVisenTrigger instance each time 
