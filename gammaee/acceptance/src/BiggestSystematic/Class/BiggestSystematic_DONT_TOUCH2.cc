...
// Module:      BiggestSystematic_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor BiggestSystematic:
//              creates a new BiggestSystematic instance each time 
