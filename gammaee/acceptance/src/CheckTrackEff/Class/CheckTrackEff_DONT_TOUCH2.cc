...
// Module:      CheckTrackEff_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor CheckTrackEff:
//              creates a new CheckTrackEff instance each time 
