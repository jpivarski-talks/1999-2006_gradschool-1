...
// Module:      LookForWierdTrigger_DONT_TOUCH
// 
...
//
// Author:      Jim Pivarski
// Created:     Mon Jun  7 11:57:03 EDT 2004
// $Id$
//
// Revision history
//
...
void
LookForWierdTrigger::bind(
   ActionBase::ActionResult (LookForWierdTrigger::*iMethod)( Frame& ),
   const Stream::Type& iStream )
{
   bindAction( iStream, new Action<LookForWierdTrigger>( iMethod, this ) );
}
