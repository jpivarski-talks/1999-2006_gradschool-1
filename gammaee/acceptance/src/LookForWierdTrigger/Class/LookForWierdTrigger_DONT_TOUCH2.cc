...
// Module:      LookForWierdTrigger_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor LookForWierdTrigger:
//              creates a new LookForWierdTrigger instance each time 
...
makeProcessor( void )
{
   return new LookForWierdTrigger;
}
