...
// Module:      ExtractMCDecayTree_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor ExtractMCDecayTree:
//              creates a new ExtractMCDecayTree instance each time 
