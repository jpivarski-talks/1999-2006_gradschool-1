...
// Module:      HitEfficiency_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor HitEfficiency:
//              creates a new HitEfficiency instance each time 
