...
## NOTE: the following two producers are probably dangerous to 
##   use when reading from a .rp file generated by QQ since
##   the beam energy and beam position may not agree with the file
   prod sel BeamPositionProd
   param BeamPositionProd useDefaultForMissingRuns true
...
#######################################################
# CVS Info
# $Id: cleog.tcl,v 1.62 2002/05/13 18:32:17 bkh Exp $
#
# $Log: cleog.tcl,v $
