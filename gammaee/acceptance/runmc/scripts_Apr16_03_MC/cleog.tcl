...
## particle properties
#  MCDecayTree needs a particle property store, which comes from the 
#  physics stream, and a source for the physics stream
#  
#   prod sel MCInfoDelivery
#  param MCInfoDelivery userDecayDec mydecay.dec
...
#     param MCSymmetricBeamProd BeamSpotMenu useXSizeParam true
#     param MCSymmetricBeamProd BeamSpotMenu useYSizeParam true
#     param MCSymmetricBeamProd BeamSpotMenu useZSizeParam true
#     param MCSymmetricBeamProd BeamSpotMenu useZeroCenter true
...
#######################################################
# CVS Info
# $Id: cleog.tcl,v 1.65 2002/09/27 20:41:17 bkh Exp $
#
# $Log: cleog.tcl,v $
