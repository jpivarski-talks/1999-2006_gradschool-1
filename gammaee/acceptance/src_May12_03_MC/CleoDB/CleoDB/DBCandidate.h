#if !defined(CLEODB_DBCANDIDATE_H)
...
// $Id: DBCandidate.h,v 1.6 1999/10/08 23:06:14 wsun Exp $
//
// Revision history
//
// $Log: DBCandidate.h,v $
...
class DBCandidate
{
   public:
	 ...
	 kMaxHypo
      ...
      static GeV mass( DBCandidate::Hypo aHypo ) ;
      ...
      // is outward.
      static DABoolean hypoIsInward( DBCandidate::Hypo aHypo )
      { return aHypo < kExitElectron ; }

   private:
      static const GeV book_mass[ kMaxHypo ] ;
};
