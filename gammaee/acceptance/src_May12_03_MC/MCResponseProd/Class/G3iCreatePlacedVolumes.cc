...
// $Id: G3iCreatePlacedVolumes.cc,v 1.3 2002/11/27 21:01:12 bkh Exp $
//
// Revision history
//
// $Log: G3iCreatePlacedVolumes.cc,v $
// Revision 1.3  2002/11/27 21:01:12  bkh
// Build ZD if in fact we should
// Improve error message in volume creation
//
// Revision 1.2  2002/10/21 21:28:19  bkh
...
G3iCreatePlacedVolumes::getRotation( const HepTransform3D& aTransform  )
{
   ...
   if( !isIdentityRotation || 0 == k_identityRotationNumber )
   {
      ...
      cggrot_( iRot , cName, 38 ) ; // gets next available rotation matrix number
