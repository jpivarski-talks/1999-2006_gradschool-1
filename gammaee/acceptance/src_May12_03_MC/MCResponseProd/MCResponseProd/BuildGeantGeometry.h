...
// $Id: BuildGeantGeometry.h,v 1.4 2002/09/27 20:28:09 bkh Exp $
//
// Revision history
//
// $Log: BuildGeantGeometry.h,v $
// Revision 1.4  2002/09/27 20:28:09  bkh
// Add ZD
//
   ...
   public:
      ...
      class UseComponent
      {
         ...
         UseComponent(DABoolean iDoSVGeom, 
           ...
           DABoolean doZDGeom() const { return m_doZDGeom;}
