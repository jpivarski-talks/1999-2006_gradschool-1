...
// $Id: MCRawRichHitsProxy.h,v 1.8 2002/09/27 20:23:43 bkh Exp $
//
// Revision history
//
// $Log: MCRawRichHitsProxy.h,v $
// Revision 1.8  2002/09/27 20:23:43  bkh
// ZD addition
...
class MCRawRichHitsProxy : public ProxyBindableTemplate< RawRichHits >
{
   ...
   private:
      ...
      const Parameter<DABoolean>& m_makeMCRawRichHits;

      const Parameter<DABoolean>& m_useFakeMerge;
      const Parameter<float>&     m_NoiseScaleFactor;
