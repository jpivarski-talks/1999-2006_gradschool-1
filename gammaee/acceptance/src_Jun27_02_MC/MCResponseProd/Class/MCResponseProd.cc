...
// $Id: MCResponseProd.cc,v 1.23 2001/04/16 05:16:42 savinov Exp $
//
//
...
static const char* const kIdString  = "$Id: MCResponseProd.cc,v 1.23 2001/04/16 05:16:42 savinov Exp $";
