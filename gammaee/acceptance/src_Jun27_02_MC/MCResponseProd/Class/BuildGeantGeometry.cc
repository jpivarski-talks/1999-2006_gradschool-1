...
// $Id: BuildGeantGeometry.cc,v 1.29 2001/09/25 21:38:07 bkh Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: BuildGeantGeometry.cc,v 1.29 2001/09/25 21:38:07 bkh Exp $";
...
//
void BuildGeantGeometry::create( const Frame& iFrame , const UseComponent& iUseComponent )
{
   report( INFO, kFacilityString ) << "Building Geant Geometry" << endl << endl;
   ...
   report( DEBUG, kFacilityString ) << "Extracted Coil Detector Geometry" << endl;
...
//   report( INFO, kFacilityString ) << "Extracted SV Detector Geometry" << endl;

   // DRWL - DR wire layer which includes DR3
...
//   report( DEBUG, kFacilityString ) << "Extracted DRWL Detector Geometry" << endl;
...
//   report( INFO, kFacilityString ) << "Extracted Rich Detector Geometry" << endl;
...
//   report( INFO, kFacilityString ) << "Extracted CC Detector Geometry" << endl;

//   // MUON 
//   FAItem< DGDetectorStore > muDetectorStore ;
//   extract( iFrame.record( Stream::kBaseGeometry ), muDetectorStore, "MU");
//   report( INFO, kFacilityString ) << "Extracted MU Detector Geometry" << endl;
...
//   	    DRWireLayerParams::kDRWLSecondaryID );
//   report( DEBUG, kFacilityString ) << "Extracted DRWL GeantExtraVolSpecsStore" << endl;

   // RICH 
//   FAItem< G3iExtraVolSpecsStore > richGeantExtraVolSpecsStore;
//   extract( iFrame.record( Stream::kRICHAlignment ), richGeantExtraVolSpecsStore,
// 	    RichGeom::k_RichAlignedGeometryUsageTag );
//   report(INFO, kFacilityString ) << "Extracted Rich GeantExtraVolSpecsStore" 
//                                  << endl;
...
//   extract( iFrame.record( Stream::kStartRun ), muGeantExtraVolSpecsStore, 	    "MU" );
//   report( INFO, kFacilityString ) << "Extracted MUON GeantExtraVolSpecsStore"
//				   << endl;
   ...
   if ( iUseComponent.doSVGeom() != 0 ) {
     ...
     report( INFO, kFacilityString ) << "SV Geant Volumes NOT CREATED" << endl;
   }
   ...
   if ( iUseComponent.doDRGeom() != 0 ) {
     ...
     extract( iFrame.record( Stream::kStartRun ), drwlGeantExtraVolSpecsStore,
     	    DRWireLayerParams::kDRWLSecondaryID );
     report( DEBUG, kFacilityString ) << "Extracted DRWL GeantExtraVolSpecsStore" 
                                      << endl;
     ...
     report( INFO, kFacilityString ) << "DR Geant Volumes NOT CREATED" << endl;
   }
   

   // RICH 
   // ----
   report( DEBUG, kFacilityString ) << "Are Rich Geant volumes to be created: " 
                                    << iUseComponent.doRichGeom()
                                    << endl;

   if ( iUseComponent.doRichGeom() != 0 ) {
     ...
     report( INFO, kFacilityString ) << "Rich Geant Volumes NOT CREATED" << endl;
   }

   // CC 
   // --
   report( DEBUG, kFacilityString ) << "Are CC Geant volumes to be created: " 
                                    << iUseComponent.doCCGeom()
                                    << endl;

   if ( iUseComponent.doCCGeom() != 0 ) {
     ...
     report( INFO, kFacilityString ) << "CC Geant Volumes NOT CREATED" << endl;
   }

   // MU
   // --
   report( DEBUG, kFacilityString ) << "Are MU Geant volumes to be created: " 
                                    << iUseComponent.doMUGeom()
                                    << endl;

   if ( iUseComponent.doMUGeom() != 0 ) {
     ...
     report( DEBUG, kFacilityString ) << "Created MUON Geant Volumes" 
                                      << endl;

   } 
   else {
     report( INFO, kFacilityString ) << "MU Geant Volumes NOT CREATED" 
                                     << endl;
   }
