...
// $Id: MCRawData.cc,v 1.15 2002/06/13 19:53:35 bkh Exp $
//
// Revision history
//
// $Log: MCRawData.cc,v $
...
//			 new ProxyFactoryArgument< MCRawCCHitsProxy,
//                          const Parameter<DABoolean>& >(m_getMCRawCCHits), 
//			 UsageTag() );    // or UsageTag( "MyUsage" )
   ...
   registerProxyFactory( Stream::kEvent, 
                         ...
                         UsageTag() );
//   registerProxyFactory( Stream::kEvent, 
//			 new ProxyFactoryArgument< MCRawCathodesProxy,
//                         const Parameter<DABoolean>& >(m_getMCRawCathodesHits), 
//  			 new ProxyFactory< MCRawCathodesProxy >, 
//			 UsageTag() );    // or UsageTag( "MyUsage" )
   registerProxyFactory( Stream::kEvent, 
			 new ProxyFactoryArgument< MCRawDRHitsProxy,
                           const Parameter<DABoolean>& >(m_getMCRawDRHits), 
//			 new ProxyFactory< MCRawDRHitsProxy >, 
			 UsageTag() );    // or UsageTag( "MyUsage" )
   registerProxyFactory( Stream::kEvent, 
...
//			 new ProxyFactory< MCRawMUHitsProxy >, 
   ...
   registerProxyFactory( Stream::kEndRun, 
			 ...
			 UsageTag() );    // or UsageTag( "MyUsage" )
//   registerProxyFactory( Stream::kEvent, 
//			 new ProxyFactoryArgument< MCRawRichHitsProxy,
//                           const Parameter<DABoolean>& >(m_getMCRawRichHits), 
// //			 new ProxyFactory< MCRawRichHitsProxy >, 
//			 UsageTag() );    // or UsageTag( "MyUsage" )
   registerProxyFactory( Stream::kEvent, 
                         new ProxyFactoryFunction
                         ...
                         UsageTag() );
   registerProxyFactory( Stream::kBeginRun, 
			 new ProxyFactory< MCRawRunControlProxy >, 
			 UsageTag() );    // or UsageTag( "MyUsage" )
   registerProxyFactory( Stream::kEndRun, 
			 new ProxyFactory< MCRawRunControlProxy >, 
			 UsageTag() );    // or UsageTag( "MyUsage" )
...
{
   return new MCRawCCHitsProxy( m_getMCRawCCHits,  m_useCCFakeMerge );
}
...
{
   return new MCRawSVHitsProxy(m_getMCRawSVHits,  m_useSVFakeMerge, m_useSVCMNoiseValue);
}

ProxyBase*
MCRawData::makeMCRawRichHitsProxy()
{
   return new MCRawRichHitsProxy(m_getMCRawRichHits,  m_useRichFakeMerge, m_useRichNoiseScaleFactor);
}
...
//template class ProxyFactoryArgument< MCRawCCHitsProxy, const Parameter<DABoolean>&  >;
//template class ProxyFactoryArgument< MCRawCathodesProxy, const Parameter<DABoolean>&  >;
...
template class ProxyFactory< MCRawLuminosityProxy    >;
...
// template class ProxyFactoryArgument< MCRawRichHitsProxy, const Parameter<DABoolean>&  >;
template class ProxyFactory< MCRawRunControlProxy    >;
