...
// $Id: SMMakeContents.cc,v 1.5 2000/05/12 15:44:03 cdj Exp $
//
// Revision history
//
...
//static const char* const kIdString  = "$Id: SMMakeContents.cc,v 1.5 2000/05/12 15:44:03 cdj Exp $";
...
smmakecontents_deliver( T*, 
   ...
   Helper& helper = reinterpret_cast< Helper& > ( iHelperBase );
