...
// $Id: SMContents.cc,v 1.4 2000/10/01 15:00:17 cdj Exp $
//
// Revision history
//
// $Log: SMContents.cc,v $
...
//static const char* const kIdString  = "$Id: SMContents.cc,v 1.4 2000/10/01 15:00:17 cdj Exp $";
...
SMContents<Iterator>::store( SMSinkStream& iSink ) const
{
   ...
   Helper& helper = reinterpret_cast< Helper& > ( storageHelper() );
