...
//
// Package:     <MCInfo>
// Module:      instantiate_transform_qqid_string.cc
// 
// Description: instantiate the STL transform algorithm used for qqid --> name
//              (const iterator over qqid)
//
// Author:      Lawrence Gibbons
// Created:     Sat Nov  7 16:48:05 EST 1998
// $Id: instantiate_transform_const_qqid_string.cc,v 1.1 1999/06/22 21:29:36 lkg Exp $
//
// Revision history
//
//
...
typedef string _unary_function_result_ ;
...
typedef MCParticlePropertyStore::TransQQToName _transform_unary_fcn_ ;
