...
// $Id: MCRawTriggerProxy.h,v 1.10 2003/01/29 19:31:10 cleo3 Exp $
//
// Revision history
//
// $Log: MCRawTriggerProxy.h,v $
// Revision 1.10  2003/01/29 19:31:10  cleo3
// changes needed to compile using g++
//
// Revision 1.9  2002/09/27 20:23:44  bkh
// ZD addition
...
class MCRawTriggerProxy : public ProxyTemplate< RawTrigger >
{
   ...
   public:
      ...
      enum  XtalMapOptions // Xtal map options
      {
      ...
      enum  GreyBits // greybits
      {
         kLoBit,        // lo greybit = 0
         kHiBit,        // hi greybit = 1
         kNumGreybits   // number of greybits = 2
      };
      enum  ShowerType // types of showers
      {
         kLo = 0,             // Lo shower = 0
         kMd = 1,             // Mid shower = 1
         kHi = 2,             // Hi shower = 2
      ...
      enum  TurnOn // constants used to characterize turn-on curves: findProb
      {
         kHeight,         // constant H
         kBase1,          // constant B1
         kErg1,           // constant E1
   ...
   private:
      ...
      const Parameter<DABoolean>& m_getRawTrigger ;
