...
// $Id: MCRawDRHitsProxy.cc,v 1.13 2003/01/29 19:31:05 cleo3 Exp $
//
// Revision history
//
// $Log: MCRawDRHitsProxy.cc,v $
// Revision 1.13  2003/01/29 19:31:05  cleo3
// changes needed to compile using g++
//
// Revision 1.12  2002/09/27 20:23:09  bkh
// ZD addition
...
//
MCRawDRHitsProxy::MCRawDRHitsProxy( const Parameter<DABoolean>& aMakeMCRawDRHits) :
   m_RawDRHits( 0 ) ,
   m_words    () ,
   m_makeMCRawDRHits ( aMakeMCRawDRHits )
{
   report ( DEBUG, kReport) 
      << "MakeMCRawDRHits: " << m_makeMCRawDRHits.value() << endl;
