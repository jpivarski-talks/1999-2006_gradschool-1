...
// $Id: EvtGenModelsInternalCommand.cc,v 1.1.1.1 2003/10/07 02:48:12 ryd Exp $
//
// Revision history
//
// $Log: EvtGenModelsInternalCommand.cc,v $
...
//
static const char* const kFacilityString = "EvtGenModels.EvtGenModelsInternalCommand" ;

// ---- cvs-based strings (Id and Tag with which file was checked out)
static const char* const kIdString  = "$Id: EvtGenModelsInternalCommand.cc,v 1.1.1.1 2003/10/07 02:48:12 ryd Exp $";
...
//
EvtGenModelsInternalCommand::EvtGenModelsInternalCommand( const Command::Name& iName, 
						EvtGenModels* target )
   : Command( iName, target, true ) // "false" to make it external command
{
   ...
   addSubcommand( 
      new Subcommand< EvtGenModelsInternalCommand >(
         "help", 2, 2,
         &EvtGenModelsInternalCommand::helpHandler,
         this )
      );
   addSubcommand( 
      new Subcommand< EvtGenModelsInternalCommand >(
         "print", 3, 3,
         &EvtGenModelsInternalCommand::printHandler,
         this )
      );
}

// EvtGenModelsInternalCommand::EvtGenModelsInternalCommand( 
//      const EvtGenModelsInternalCommand& rhs )
// {
...
//
// const EvtGenModelsInternalCommand& EvtGenModelsInternalCommand::operator=( 
//       const EvtGenModelsInternalCommand& rhs )
// {
//   if( this != &rhs ) {
...
//int
//int
//EvtGenModelsInternalCommand::execute( int argc, char* argv[] )
//{
...
EvtGenModels*
EvtGenModelsInternalCommand::target()
{
...
//
const EvtGenModels*
EvtGenModelsInternalCommand::target() const
{
