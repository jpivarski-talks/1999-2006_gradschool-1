# getMCConstants.tcl
# You should not be using this script any more.
# Use either getMCNewestConstants.tcl to get the most recent versions
#         or getMCPass2_3Constants.tcl to get frozen versions.
#
