...
foreach $type ("ee", "mumu", "tautau", "ee0", "mumu0", "tautau0") {
    
    # y1s
    @runs = (123633, 123635, 123636, 123637, 123638, 123639, 123640) if $type eq "ee";
    @runs = (123641, 123643, 123644, 123645, 123646, 123647, 123648) if $type eq "mumu";
    @runs = (123650, 123651, 123652, 123653, 123654, 123656, 123658) if $type eq "tautau";
    @runs = (123633, 123635, 123636, 123637, 123638, 123639, 123640) if $type eq "ee0";
    @runs = (123641, 123643, 123644, 123645, 123646, 123647, 123648) if $type eq "mumu0";
    @runs = (123650, 123651, 123652, 123653, 123654, 123656, 123658) if $type eq "tautau0";
...
";
    ...
    # y2s
    @runs = (129567, 129568, 129572, 129573, 129574, 129575, 129576) if $type eq "ee";
    @runs = (129579, 129580, 129582, 129591, 129607, 129611, 129617) if $type eq "mumu";
    @runs = (129618, 129619, 129620, 129623, 129626, 129629, 129630) if $type eq "tautau";
    @runs = (129567, 129568, 129572, 129573, 129574, 129575, 129576) if $type eq "ee0";
    @runs = (129579, 129580, 129582, 129591, 129607, 129611, 129617) if $type eq "mumu0";
    @runs = (129618, 129619, 129620, 129623, 129626, 129629, 129630) if $type eq "tautau0";
...
";
    ...
    # y3s
    @runs = (121940, 121943, 121944, 121946, 121948, 121949, 121950) if $type eq "ee";
    @runs = (121951, 121952, 121953, 121962, 121963, 121965, 121966) if $type eq "mumu";
    @runs = (121968, 121969, 121970, 121972, 121973, 121974, 121975) if $type eq "tautau";
    @runs = (121940, 121943, 121944, 121946, 121948, 121949, 121950) if $type eq "ee0";
    @runs = (121951, 121952, 121953, 121962, 121963, 121965, 121966) if $type eq "mumu0";
    @runs = (121968, 121969, 121970, 121972, 121973, 121974, 121975) if $type eq "tautau0";
