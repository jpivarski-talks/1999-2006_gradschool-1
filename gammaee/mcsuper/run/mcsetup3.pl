...
foreach $type ("scas", "scas0") {

    # y2s
    @runs = (129535, 129536, 129538, 129539, 129540, 129541, 129545,
	     129549, 129550, 129551, 129552, 129553, 129564, 129566,
	     129567, 129568, 129572, 129573, 129574, 129575, 129576) if $type eq "scas";
    @runs = (129535, 129536, 129538, 129539, 129540, 129541, 129545,
	     129549, 129550, 129551, 129552, 129553, 129564, 129566,
	     129567, 129568, 129572, 129573, 129574, 129575, 129576) if $type eq "scas0";
...
";
    ...
    @runs = (121916, 121917, 121918, 121920, 121924, 121925, 121927,
	     ...
	     121940, 121943, 121944, 121946, 121948, 121949, 121950) if $type eq "scas";
    @runs = (121916, 121917, 121918, 121920, 121924, 121925, 121927,
	     121928, 121929, 121930, 121932, 121933, 121936, 121939,
	     121940, 121943, 121944, 121946, 121948, 121949, 121950) if $type eq "scas0";
