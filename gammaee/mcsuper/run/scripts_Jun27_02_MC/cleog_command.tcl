...
tcl_proc cleog_file args {
   ...
   if { 0 == [string compare $rpExtension [string range $fileName end-[expr [string length $rpExtension] -1] end] ] } {
       ...
       if [catch {
	   set argsArray(-post) [linsert $argsArray(-post) 0 "param TrackletBunchFinder ForceTimeOffset true; param TrackletBunchFinder TheForcedTimeOffset 0.0;"]
       } ] {
	   set argsArray(-post) "param TrackletBunchFinder ForceTimeOffset true; param TrackletBunchFinder TheForcedTimeOffset 0.0;"
       }
