...
root file ../rzn/egY2trig_2.root
root init
cleog gen EvtGenProd 2000 out ../rzn/y2seg_temp.pds run 129535 -user_decay ../data_method/evtgen/ups2s.dec -standard_decay ../data_method/evtgen/DECAY.DEC -post {
    ...
    param MCSymmetricBeamProd BWResonanceMass 10.02326;
    param MCSymmetricBeamProd BWResonanceWidth 0.000044;
