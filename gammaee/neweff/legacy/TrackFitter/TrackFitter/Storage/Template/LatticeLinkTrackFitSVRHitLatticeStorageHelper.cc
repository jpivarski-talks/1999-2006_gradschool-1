...
// $Id: LatticeLinkTrackFitSVRHitLatticeStorageHelper.cc,v 1.8 2002/02/14 20:07:03 cleo3 Exp $
//
// Revision history
//
// $Log: LatticeLinkTrackFitSVRHitLatticeStorageHelper.cc,v $
// Revision 1.8  2002/02/14 20:07:03  cleo3
...
static const char* const kSMIdString  = "$Id: LatticeLinkTrackFitSVRHitLatticeStorageHelper.cc,v 1.8 2002/02/14 20:07:03 cleo3 Exp $";
...
LatticeLinkTrackFitSVRHitLatticeStorageHelper<H>::implementStore( 
   ...
   const SMLatticeLinkInfoBase<
      typename LatticeLinkTrackFitSVRHitLatticeStorageHelper<H>::TrackFitSVRHitLattice >&
      iData ) 
{
