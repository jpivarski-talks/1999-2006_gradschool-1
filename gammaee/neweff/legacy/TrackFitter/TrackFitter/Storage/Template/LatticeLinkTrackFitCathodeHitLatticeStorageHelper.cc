...
// $Id: LatticeLinkTrackFitCathodeHitLatticeStorageHelper.cc,v 1.7 2002/06/12 20:42:35 cleo3 Exp $
//
// Revision history
//
// $Log: LatticeLinkTrackFitCathodeHitLatticeStorageHelper.cc,v $
// Revision 1.7  2002/06/12 20:42:35  cleo3
...
static const char* const kSMIdString  = "$Id: LatticeLinkTrackFitCathodeHitLatticeStorageHelper.cc,v 1.7 2002/06/12 20:42:35 cleo3 Exp $";
static const char* const kSMTagString = "$Name: v07_07_01 $";
...
LatticeLinkTrackFitCathodeHitLatticeStorageHelper<H>::implementStore( 
   ...
   const SMLatticeLinkInfoBase<
      typename LatticeLinkTrackFitCathodeHitLatticeStorageHelper<H>::TrackFitCathodeHitLattice >&
      iData ) 
{
