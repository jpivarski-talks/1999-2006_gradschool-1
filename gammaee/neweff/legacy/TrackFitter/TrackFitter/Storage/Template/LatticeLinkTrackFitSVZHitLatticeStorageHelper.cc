...
// $Id: LatticeLinkTrackFitSVZHitLatticeStorageHelper.cc,v 1.7 2002/02/14 20:07:04 cleo3 Exp $
//
// Revision history
//
// $Log: LatticeLinkTrackFitSVZHitLatticeStorageHelper.cc,v $
// Revision 1.7  2002/02/14 20:07:04  cleo3
...
static const char* const kSMIdString  = "$Id: LatticeLinkTrackFitSVZHitLatticeStorageHelper.cc,v 1.7 2002/02/14 20:07:04 cleo3 Exp $";
...
LatticeLinkTrackFitSVZHitLatticeStorageHelper<H>::implementStore( 
   ...
   const SMLatticeLinkInfoBase<
      typename LatticeLinkTrackFitSVZHitLatticeStorageHelper<H>::TrackFitSVZHitLattice>&
      iData ) 
{
