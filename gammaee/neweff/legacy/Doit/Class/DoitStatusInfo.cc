...
// $Id: DoitStatusInfo.cc,v 1.5 2002/08/16 14:44:41 cleo3 Exp $
//
// Revision history
//
// $Log: DoitStatusInfo.cc,v $
// Revision 1.5  2002/08/16 14:44:41  cleo3
// replaced iostream.h with C++/iostream.h
//
// Revision 1.4  2002/05/23 14:39:11  dpp
...
static const char* const kIdString  = "$Id: DoitStatusInfo.cc,v 1.5 2002/08/16 14:44:41 cleo3 Exp $";
static const char* const kTagString = "$Name: v03_28_00 $";
...
void DoitStatusInfo::printout(ostream& s) const
{
  ...
  reportFlag( s, "tested_for_a_limited_radius_solution",
	      limitRadiusSolutionTest() );
  reportFlag( s, "found_a_limited_radius_solution",
	      limitRadiusSolutionSol() );
  reportFlag( s, "this_is_a_selected_limited_radius_solution",
	      limitRadiusSolutionSel() );
