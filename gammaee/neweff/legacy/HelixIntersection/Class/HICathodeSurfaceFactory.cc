...
// $Id: HICathodeSurfaceFactory.cc,v 1.10 2002/03/13 19:49:29 wsun Exp $
//
// Revision history
//
// $Log: HICathodeSurfaceFactory.cc,v $
// Revision 1.10  2002/03/13 19:49:29  wsun
// Replaced aluminum with DR gas.
//
...
static const char* const kIdString  = "$Id: HICathodeSurfaceFactory.cc,v 1.10 2002/03/13 19:49:29 wsun Exp $";
static const char* const kTagString = "$Name: v12_01_02 $";
...
//    m_aluminum = placedAlVolume->volume()->material() ;
   ...
   // wsun 3-13-02: Since the cathode surface is not at the physical cathodes,
   // but just outside of layer 47, the outer material should be DR gas
   // instead of aluminum.  A surface corresponding to the physical cathodes
   // should be added if the fitter some day includes the CC or Rich hits.
   m_aluminum = materials[ kGasWireVaporMatID ] ;
