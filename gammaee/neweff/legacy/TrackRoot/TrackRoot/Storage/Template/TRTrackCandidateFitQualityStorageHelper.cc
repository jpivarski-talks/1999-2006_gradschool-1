...
// $Id: TRTrackCandidateFitQualityStorageHelper.cc,v 1.11 2002/04/02 15:04:55 cdj Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: TRTrackCandidateFitQualityStorageHelper.cc,v 1.11 2002/04/02 15:04:55 cdj Exp $";
