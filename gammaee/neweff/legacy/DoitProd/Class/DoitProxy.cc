...
// $Id: DoitProxy.cc,v 1.10 2002/09/27 21:04:16 bkh Exp $
//
// Revision history
//
// $Log: DoitProxy.cc,v $
// Revision 1.10  2002/09/27 21:04:16  bkh
// For ZD capability
//
...
static const char* const kIdString  = "$Id: DoitProxy.cc,v 1.10 2002/09/27 21:04:16 bkh Exp $";
			 ...
			 const DataKey& iKey )
{
  ...
  if ( m_doitProd )
  {
    ...
    m_theDoitTrackFinder.setZDUsage(      m_doitProd->useZD() );
  }
