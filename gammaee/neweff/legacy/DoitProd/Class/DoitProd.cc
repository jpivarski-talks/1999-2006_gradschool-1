...
// $Id: DoitProd.cc,v 1.10 2002/09/27 21:04:15 bkh Exp $
//
// Revision history
//
// $Log: DoitProd.cc,v $
// Revision 1.10  2002/09/27 21:04:15  bkh
// For ZD capability
//
...
static const char* const kIdString  = "$Id: DoitProd.cc,v 1.10 2002/09/27 21:04:15 bkh Exp $";
static const char* const kTagString = "$Name: v02_00_00 $";
     ...
     m_useZD("UseZD", this, true )
{
  ...
  m_modeNumber.setHelpString("Use the default unless told otherwise!\n");
   ...
   registerProxyFactory( Stream::kEvent, 
			 new ProxyFactory< DoitZDLatticeProxy >, 
			 UsageTag() );
...
template class ProxyFactory< DoitZDLatticeProxy >;
