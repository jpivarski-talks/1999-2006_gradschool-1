...
// $Id: DoitZDLatticeProxy.cc,v 1.1 2002/09/27 21:04:16 bkh Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: DoitZDLatticeProxy.cc,v 1.1 2002/09/27 21:04:16 bkh Exp $";
