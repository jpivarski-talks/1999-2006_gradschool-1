...
// Module:      UpsilonGammaEECascadesProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor UpsilonGammaEECascadesProc:
//              creates a new UpsilonGammaEECascadesProc instance each time 
...
makeProcessor( void )
{
   return new UpsilonGammaEECascadesProc;
}
