...
// Module:      TriggerOnlyProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor TriggerOnlyProc:
//              creates a new TriggerOnlyProc instance each time 
