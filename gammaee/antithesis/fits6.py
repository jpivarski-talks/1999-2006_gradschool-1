...
def u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w):
  tmp = 0.
  tmp += area * 0.9767 * mygbwkf(9460.30, fullgam, rmsbeam, yint, phi, w)
...
def u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w):
  tmp = 0.
  tmp += area * 0.9596 * mygbwkf(10023.26, fullgam, rmsbeam, yint, phi, w)
...
def u1fit(area, rmsbeam, back, jan16, jan30, feb06, feb13, feb20, feb27, mar06, mar13, apr03, apr08, apr09, apr10, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, rjan16, rjan30, rfeb06, rfeb13, rfeb20, rfeb27, rmar06, rmar13, rapr03, rapr08, rapr09, rapr10):
  chi = 0.
  ...
  chi += chicontrib(u1data["jan16"], jan16, lambda w: u1func(area, rjan16, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  chi += chicontrib(u1data["jan30"], jan30, lambda w: u1func(area, rjan30, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  chi += chicontrib(u1data["feb06"], feb06, lambda w: u1func(area, rfeb06, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  chi += chicontrib(u1data["feb13"], feb13, lambda w: u1func(area, rfeb13, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  chi += chicontrib(u1data["feb20"], feb20, lambda w: u1func(area, rfeb20, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  chi += chicontrib(u1data["feb27"], feb27, lambda w: u1func(area, rfeb27, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  chi += chicontrib(u1data["mar06"], mar06, lambda w: u1func(area, rmar06, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  chi += chicontrib(u1data["mar13"], mar13, lambda w: u1func(area, rmar13, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  chi += chicontrib(u1data["apr03"], apr03, lambda w: u1func(area, rapr03, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  chi += chicontrib(u1data["apr08"], apr08, lambda w: u1func(area, rapr08, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  chi += chicontrib(u1data["apr09"], apr09, lambda w: u1func(area, rapr09, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  chi += chicontrib(u1data["apr10"], apr10, lambda w: u1func(area, rapr10, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  return chi

def u2fit(area, rmsbeam, back, may29, jun11, jun12, jul10, jul24, aug07, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, rmay29, rjun11, rjun12, rjul10, rjul24, raug07):
  chi = 0.
  ...
  chi += chicontrib(u2data["may29"], may29, lambda w: u2func(area, rmay29, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
  chi += chicontrib(u2data["jun11"], jun11, lambda w: u2func(area, rjun11, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
  chi += chicontrib(u2data["jun12"], jun12, lambda w: u2func(area, rjun12, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
  chi += chicontrib(u2data["jul10"], jul10, lambda w: u2func(area, rjul10, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
  chi += chicontrib(u2data["jul24"], jul24, lambda w: u2func(area, rjul24, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
  chi += chicontrib(u2data["aug07"], aug07, lambda w: u2func(area, raug07, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
  return chi
...
# u1fitter.values = [13.7 * nbish2nb, 3.79, 0.404 * nbish2nb, 0.25, 0.63, 0.076, 0.066, 0.23, 0.19, 0.20, 0.57, 0.92, 0.80, 0.46, 0.62, 0.053, 0.01864, 0., 0.0267, 0.20, 0., 0.0792, 3.787392, 3.787392, 3.787392, 3.787392, 3.787392, 3.787392, 3.787392, 3.787392, 3.787392, 3.787392, 3.787392, 3.787392]
...
# u1fitter.release(["rjan16", "rjan30", "rfeb06", "rfeb13", "rfeb20", "rfeb27", "rmar06", "rmar13", "rapr03", "rapr08", "rapr09", "rapr10"])
...
# print "u1, Jean's B_tautau:", u1fitter.values[0], u1fitter.fval
...
print "u1, Istvan's B_mumu:", u1fitter.values[0], "+/-", u1fitter.minos_errors[0], u1fitter.fval

################################################################

u2fitter = Minuit(u2fit)
u2fitter.values = [5.72 * nbish2nb, 4.1758, 0.40496499767 * nbish2nb, -1.127, -1.065, -1.42, -0.76, -0.6656, -0.39747, 0.043, 0.01792, 0., 0.017, 0.37, 0., 0.0792, u1fitter.values[0], 4.175824, 4.175824, 4.175824, 4.175824, 4.175824, 4.175824]
u2fitter.fix(range(u2fitter.npar))
u2fitter.release(["area", "back"])
u2fitter.release(["may29", "jun11", "jun12", "jul10", "jul24", "aug07"])
u2fitter.release(["rmay29", "rjun11", "rjun12", "rjul10", "rjul24", "raug07"])
...
print "u2, it's all the same:", u2fitter.values[0], "+/-", u2fitter.minos_errors[0], u2fitter.fval

################################################################

# u3fitter = Minuit(u3fit)
# u3fitter.values = [3.58 * nbish2nb, 4.48, 0.404 * nbish2nb, -2.12, -3.99, -3.18, -2.46, -2.72, -2.55, -2.64, 0.0263, 0.01823, 0., 0.0239, 0.27, 0., 0.0792, u1fitter.values[0], u2fitter.values[0], 4.479665, 4.479665, 4.479665, 4.479665, 4.479665, 4.479665, 4.479665]
...
# print "u3, Jean's B_tautau:", u3fitter.values[0], u3fitter.fval
...
print "u3, Istvan's B_mumu:", u3fitter.values[0], "+/-", u3fitter.minos_errors[0], u3fitter.fval
