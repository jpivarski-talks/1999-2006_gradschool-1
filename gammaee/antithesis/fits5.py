...
def u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w):
  tmp = 0.
  tmp += area * 0.9779 * mygbwkf(9460.30, fullgam, rmsbeam, yint, phi, w)
...
def u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w):
  tmp = 0.
  tmp += area * 0.9608 * mygbwkf(10023.26, fullgam, rmsbeam, yint, phi, w)
...
def u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w):
  tmp = 0.
  tmp += area * 0.9617 * mygbwkf(10355.2, fullgam, rmsbeam, yint, phi, w)
...
pickle.dump(fitrecord, open("/home/mccann/antithesis/fit_results/fits5_which_are_final.p", 'w'))
