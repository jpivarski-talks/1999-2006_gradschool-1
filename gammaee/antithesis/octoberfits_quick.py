# This `fits' has been updated to have the 13 July efficiencies and
# luminosities.  It also has bhabhafits capabilities, and the
...
def doitall(lumisource, bhabha_interference):
  ...
  def u1plot(area, rmsbeam, back, jan16, jan30, feb06, feb13, feb20, feb27, mar06, mar13, apr03, apr08, apr09, apr10, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, rjan, rfeb, rapr1, rapr2):
  ...
  def u1fit(area, rmsbeam, back, jan16, jan30, feb06, feb13, feb20, feb27, mar06, mar13, apr03, apr08, apr09, apr10, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, rjan, rfeb, rapr1, rapr2):
    chi = 0.
    ...
    chi += chicontrib(u1data["apr03"], apr03, lambda w: u1func(area, rapr1, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["apr08"], apr08, lambda w: u1func(area, rapr1, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["apr09"], apr09, lambda w: u1func(area, rapr1, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  ...
  def u1plot_pull(area, rmsbeam, back, jan16, jan30, feb06, feb13, feb20, feb27, mar06, mar13, apr03, apr08, apr09, apr10, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, rjan, rfeb, rapr1, rapr2):
    p = biggles.Table(1,3)
    ...
    h.fill(adddata_pull(p[0,0], u1data["apr03"], apr03, lambda w: u1func(area, rapr1, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w)))
    h.fill(adddata_pull(p[0,0], u1data["apr08"], apr08, lambda w: u1func(area, rapr1, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w)))
    h.fill(adddata_pull(p[0,0], u1data["apr09"], apr09, lambda w: u1func(area, rapr1, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w)))
    ...
    dates += adddata_pull3(p[0,2], u1runs["apr03"], u1data["apr03"], apr03, lambda w: u1func(area, rapr1, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    dates += adddata_pull3(p[0,2], u1runs["apr08"], u1data["apr08"], apr08, lambda w: u1func(area, rapr1, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    dates += adddata_pull3(p[0,2], u1runs["apr09"], u1data["apr09"], apr09, lambda w: u1func(area, rapr1, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  ...
  def u1plot_pull_again(area, rmsbeam, back, jan16, jan30, feb06, feb13, feb20, feb27, mar06, mar13, apr03, apr08, apr09, apr10, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, rjan, rfeb, rapr1, rapr2):
    p = biggles.Table(3,1)
    p[0,0] = biggles.FramedPlot()
    ...
    dates += adddata_pull3(p[2,0], u1runs["apr03"], u1data["apr03"], apr03, lambda w: u1func(area, rapr1, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    dates += adddata_pull3(p[2,0], u1runs["apr08"], u1data["apr08"], apr08, lambda w: u1func(area, rapr1, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    dates += adddata_pull3(p[2,0], u1runs["apr09"], u1data["apr09"], apr09, lambda w: u1func(area, rapr1, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  ...
  def u1plot2(area, rmsbeam, back, jan16, jan30, feb06, feb13, feb20, feb27, mar06, mar13, apr03, apr08, apr09, apr10, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, rjan, rfeb, rapr1, rapr2, p=None, GeV=False):
  ...
  def u1plot3(area, rmsbeam, back, jan16, jan30, feb06, feb13, feb20, feb27, mar06, mar13, apr03, apr08, apr09, apr10, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, rjan, rfeb, rapr1, rapr2, p=None, GeV=False):
    if p == None: p = biggles.FramedPlot()
    x = []
    y = []
    yerr = []
  ...
  rapr1_weight = get_lumiweight(u1runs["apr03"] + u1runs["apr08"] + u1runs["apr09"])
  rapr2_weight = get_lumiweight(u1runs["apr10"])
...
#   u1fitter.release(["rjan", "rfeb", "rapr1", "rapr2"])

  u1fitter.values = [323.16, 3.79, 9.358, 0.393, 0.576, 0.038, 0.011, 0.066, 0.178, 0.495, 0.373, 0.817, 0.585, 0.631, 0.798, 0.053, 0.01864, 0., 0.0267, 0.20, 0., 0.0792, 3.816, 3.841, 3.771, 3.752]
...
#   u1fitter.values = [13.7 * nbish2nb, 3.79, 0.404 * nbish2nb, 0.25, 0.63, 0.076, 0.066, 0.23, 0.19, 0.20, 0.57, 0.92, 0.80, 0.46, 0.62, 0.053, 0.01864, 0., 0.0267, 0.20, 0., 0.0792, 3.79, 3.79, 3.79, 3.79]
  ...
  u1fitter.values[1] = float(u1fitter.values[u1fitter.findpar("rjan")] * rjan_weight + \
                             ...
                             u1fitter.values[u1fitter.findpar("rapr1")] * rapr1_weight + \
                             u1fitter.values[u1fitter.findpar("rapr2")] * rapr2_weight) / \
                        float(rjan_weight + rfeb_weight + rapr1_weight + rapr2_weight)

  u2fitter = Minuit(u2fit)
  u2fitter.fix(range(u2fitter.npar))
  u2fitter.release(["area", "back"])
#   u2fitter.release(["rmsbeam"])
#   u2fitter.release(["may29", "jun11", "jun12", "jul10", "jul24", "aug07"])

  u2fitter.values = [134.02, 4.16120148, 9.32472, -1.19605020398, -1.08958111584, -1.05331223148, -0.824425581978, -0.700450642409, -0.688687550034, 0.043, 0.01792, 0., 0.017, 0.37, 0., 0.0792, u1fitter.values[0]]
...
#   u3fitter.release(["rnov28", "rdec05", "rdec12", "rdec19", "rdec26", "rjan02", "rjan09"])
  ...
  u3fitter.values = [87.74, 4.48, 9.334, -3.172, -3.839, -2.692, -2.769, -2.659, -2.726, -2.875, 0.0263, 0.01823, 0., 0.0239, 0.27, 0., 0.0792, u1fitter.values[0], u2fitter.values[0], 4.669, 4.595, 4.576, 4.634, 4.669, 4.551, 4.622]
...
#   print "1s Istvan's B_mm: ", u1fitter
# #   print zip(u1fitter.names, u1fitter.minos_errors)
#   print "AND THE AREA IS", u1fitter.values[0], "+/-", u1fitter.minos_errors[0]
...
#   u2fitter.values = [133.2, 4.164, 9.331, -1.038, -1.080, -1.515, -0.771, -0.685, -0.392, 0.043, 0.01792, 0., 0.017, 0.37, 0., 0.0792, u1fitter.values[0]]
# #   u2fitter.values = [134.35, 4.1729038, 9.3266541666, -1.3026805137786095, -1.1816929270805803, -0.97339760477731974, -0.70258993205478371, -0.79766008329879412, -0.55654968790012116, 0.043, 0.01792, 0., 0.017, 0.37, 0., 0.0792, u1fitter.values[0]]
# #   u2fitter.values = [133.192924, 4.16326, 9.3314599, -1.0385, -1.07962, -1.51412, -0.770079, -0.684613, -0.3919418, 0.043, 0.01792, 0., 0.017, 0.37, 0., 0.0792, u1fitter.values[0]]
# #   u2fitter.values = [5.72 * nbish2nb, 4.1758, 0.40496499767 * nbish2nb, -1.127, -1.065, -1.42, -0.76, -0.6656, -0.39747, 0.043, 0.01792, 0., 0.017, 0.37, 0., 0.0792, u1fitter.values[0]]
#   u2fitter.values[u2fitter.findpar("btautau")] = 0.0203
...
#   print "2s Jean's B_tt: ", u2fitter
# #   print zip(u2fitter.names, u2fitter.minos_errors)
#   print "AND THE AREA IS", u2fitter.values[0], "+/-", u2fitter.minos_errors[0]
...
#   u3fitter.values = [86.1, 4.48, 9.315, 4.725, 4.463, 4.527, 4.696, 4.120, 4.579, 4.607, 0.0263, 0.01823, 0., 0.0239, 0.27, 0., 0.0792, u1fitter.values[0], u2fitter.values[0], -2.426, -4.224, -3.242, -2.218, -3.028, -2.736, -2.480]
# #   u3fitter.values = [3.58 * nbish2nb, 4.48, 0.404 * nbish2nb, -2.12, -3.99, -3.18, -2.46, -2.72, -2.55, -2.64, 0.0263, 0.01823, 0., 0.0239, 0.27, 0., 0.0792, u1fitter.values[0], u2fitter.values[0], 4.48, 4.48, 4.48, 4.48, 4.48, 4.48, 4.48]
#   u3fitter.values[u3fitter.findpar("btautau")] = 0.0239
#   u2fitter.values[u2fitter.findpar("tauyint")] = (2./3.)/137./u2fitter.values[u2fitter.findpar("btautau")]
#   u3fitter.migrad()
...
#   print "3s Istvan's B_mm: ", u3fitter
# #   print zip(u3fitter.names, u3fitter.minos_errors)
#   print "AND THE AREA IS", u3fitter.values[0], "+/-", u3fitter.minos_errors[0]
...
#   pickle.dump(fitrecord, open("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+".p", 'w'))
...
#   extraarea = 4.
#   u1plot_pull(*fitrecord[1].values).write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls1.eps")
...
#         dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
#   extraarea = 1.
#   u1plot_pull_again(*fitrecord[1].values).write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls1again.eps")
...
#         dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
#   extraarea = 4.
#   u2plot_pull(*fitrecord[2].values).write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls2.eps")
...
#         dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
#   extraarea = 1.
#   u2plot_pull_again(*fitrecord[2].values).write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls2again.eps")
...
#         dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
#   extraarea = 4.
#   u3plot_pull(*fitrecord[3].values).write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls3.eps")
...
#         dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
#   extraarea = 1.
#   u3plot_pull_again(*fitrecord[3].values).write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls3again.eps")
...
#   p1.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_1s.eps")
#   p2.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_2s.eps")
#   p3.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_3s.eps")
...
#   p1.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_1s.eps")
#   p2.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_2s.eps")
#   p3.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_3s.eps")
...
#   p1.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_1s.eps")
#   p2.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_2s.eps")
#   p3.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_3s.eps")
...
#   p1.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_1s.eps")
#   p2.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_2s.eps")
#   p3.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_3s.eps")
...
#   p[2,0].aspect_ratio = 0.33
#   p.aspect_ratio = 1.2
#   p.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb2.eps")
...
#   p.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb3.eps")
...
#   p[2,0].y1.range = 0., 15.
#   p.aspect_ratio = 1.2
#   p.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb.eps")
...
#   q.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_three_resonances_inset_squat2.eps")
...
#   p[2,0].x1.label = r"Center-of-mass energy (2 $\times$ beam energy) in MeV"
#   p.aspect_ratio = 1.2
#   p.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_allfit.eps")
...
#   p[2,0].x1.label = r"Center-of-mass energy (2 $\times$ beam energy) in MeV"
#   p.aspect_ratio = 1.2
#   p.write_eps("/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_allfit_comb.eps")

print "from gamgams"
doitall(0, 1.)

# print "from outer bhabhas with interference"
# doitall(2, 1.)

# print "from inner bhabhas with interference"
# doitall(1, 1.)
...
# 
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_allfit_comb.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_allfit.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb2.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb3.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_1s.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_2s.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_3s.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_1s.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_2s.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_3s.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_1s.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_2s.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_3s.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_1s.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_2s.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_3s.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls1again.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls1.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls2again.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls2.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls3again.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls3.eps")
# "/home/mccann/antithesis/fit_results/octoberfits_ggshifts_"+str(lumisource)+"_"+str(bhabha_interference)+"_three_resonances_inset_squat2.eps")
