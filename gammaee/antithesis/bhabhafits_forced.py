# This is the only `fits' that has been updated to have the 13 July
# efficiencies and luminosities.  (`fits' up to fits6.py exist.)
...
def doitall(lumisource):
  ...
  def u1fit(area, rmsbeam, back, jan16, jan30, feb06, feb13, feb20, feb27, mar06, mar13, apr03, apr08, apr09, apr10, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac):
    chi = 0.
    chi += chicontrib(u1data["cont"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["high"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["jan16"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["jan30"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["feb06"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["feb13"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["feb20"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["feb27"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["mar06"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["mar13"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["apr03"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["apr08"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["apr09"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    chi += chicontrib(u1data["apr10"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
    return chi
  ...
  def u2fit(area, rmsbeam, back, may29, jun11, jun12, jul10, jul24, aug07, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area):
    chi = 0.
    chi += chicontrib(u2data["cont"], may29, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
    chi += chicontrib(u2data["high"], may29, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
    ...
    chi += chicontrib(u2data["jun11"], may29, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
    chi += chicontrib(u2data["jun12"], may29, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
    chi += chicontrib(u2data["jul10"], may29, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
    chi += chicontrib(u2data["jul24"], may29, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
    chi += chicontrib(u2data["aug07"], may29, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
    return chi
  ...
  def u3fit(area, rmsbeam, back, nov28, dec05, dec12, dec19, dec26, jan02, jan09, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area):
    chi = 0.
    chi += chicontrib(u3data["cont"], nov28, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
    chi += chicontrib(u3data["high"], nov28, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
    ...
    chi += chicontrib(u3data["dec05"], nov28, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
    chi += chicontrib(u3data["dec12"], nov28, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
    chi += chicontrib(u3data["dec19"], nov28, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
    chi += chicontrib(u3data["dec26"], nov28, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
    chi += chicontrib(u3data["jan02"], nov28, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
    chi += chicontrib(u3data["jan09"], nov28, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
    return chi
  ...
  def u1plot_pull_again(area, rmsbeam, back, jan16, jan30, feb06, feb13, feb20, feb27, mar06, mar13, apr03, apr08, apr09, apr10, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac):
    p = biggles.Table(3,1)
    p[0,0] = biggles.FramedPlot()
  ...
  def u3plot_pull_again(area, rmsbeam, back, nov28, dec05, dec12, dec19, dec26, jan02, jan09, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area):
    p = biggles.Table(3,1)
    p[0,0] = biggles.FramedPlot()
    p[2,0] = biggles.FramedPlot()
    h = MoreThanHist(100, -5., 5.)
  ...
  u1fitter.values = [13.7 * nbish2nb, 3.79, 0.404 * nbish2nb, 0.4177, 0.4177, 0.4177, 0.4177, 0.4177, 0.4177, 0.4177, 0.4177, 0.4177, 0.4177, 0.4177, 0.4177, 0.053, 0.01864, 0., 0.0267, 0.20, 0., 0.0792]
  u1fitter.fix(range(u1fitter.npar))
  u1fitter.release(["area", "rmsbeam", "back"])
  u1fitter.release(["jan16"])
  ...
  tmp = ["jan30", "feb06", "feb13", "feb20", "feb27", "mar06", "mar13", "apr03", "apr08", "apr09", "apr10"]
  for t in tmp:
    u1fitter.values[u1fitter.findpar(t)] = u1fitter.values[u1fitter.findpar("jan16")]

  u2fitter = Minuit(u2fit)
  u2fitter.values = [5.72 * nbish2nb, 4.1758, 0.40496499767 * nbish2nb, -0.9058, -0.9058, -0.9058, -0.9058, -0.9058, -0.9058, 0.043, 0.01792, 0., 0.017, 0.37, 0., 0.0792, u1fitter.values[0]]
  u2fitter.fix(range(u2fitter.npar))
  u2fitter.release(["area", "rmsbeam", "back"])
  u2fitter.release(["may29"])
  ...
  tmp = ["jun11", "jun12", "jul10", "jul24", "aug07"]
  for t in tmp:
    u2fitter.values[u2fitter.findpar(t)] = u2fitter.values[u2fitter.findpar("may29")]

  u3fitter = Minuit(u3fit)
  u3fitter.values = [3.58 * nbish2nb, 4.48, 0.404 * nbish2nb, -2.80857, -2.80857, -2.80857, -2.80857, -2.80857, -2.80857, -2.80857, 0.0263, 0.01823, 0., 0.0239, 0.27, 0., 0.0792, u1fitter.values[0], u2fitter.values[0]]
  u3fitter.fix(range(u3fitter.npar))
  u3fitter.release(["area", "rmsbeam", "back"])
  u3fitter.release(["nov28"])
  ...
  tmp = ["dec05", "dec12", "dec19", "dec26", "jan02", "jan09"]
  for t in tmp:
    u3fitter.values[u3fitter.findpar(t)] = u3fitter.values[u3fitter.findpar("nov28")]
  ...
  pickle.dump(fitrecord, open("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+".p", 'w'))
  ...
  extraarea = 4.
  u1plot_pull(*fitrecord[1].values).write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_pulls1.eps")
  ...
  for y in (2001, 2002):
    for d in Numeric.array(range(365))+1:
        dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
  extraarea = 1.
  u1plot_pull_again(*fitrecord[1].values).write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_pulls1again.eps")
  ...
  for y in (2001, 2002):
    for d in Numeric.array(range(365))+1:
      if d % 7 == 0:
        dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
  extraarea = 4.
  u2plot_pull(*fitrecord[2].values).write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_pulls2.eps")
  ...
  for y in (2001, 2002):
    for d in Numeric.array(range(365))+1:
        dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
  extraarea = 1.
  u2plot_pull_again(*fitrecord[2].values).write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_pulls2again.eps")
  ...
  for y in (2001, 2002):
    for d in Numeric.array(range(365))+1:
      if d % 7 == 0:
        dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
  extraarea = 4.
  u3plot_pull(*fitrecord[3].values).write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_pulls3.eps")
  ...
  for y in (2001, 2002):
    for d in Numeric.array(range(365))+1:
        dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
  extraarea = 1.
  u3plot_pull_again(*fitrecord[3].values).write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_pulls3again.eps")
  ...
  p1.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual_noinset_1s.eps")
  p2.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual_noinset_2s.eps")
  p3.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual_noinset_3s.eps")
  ...
  p1.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual_withinset_1s.eps")
  p2.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual_withinset_2s.eps")
  p3.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual_withinset_3s.eps")
  ...
  p1.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual0.7_noinset_1s.eps")
  p2.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual0.7_noinset_2s.eps")
  p3.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual0.7_noinset_3s.eps")
  ...
  p1.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual0.7_withinset_1s.eps")
  p2.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual0.7_withinset_2s.eps")
  p3.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual0.7_withinset_3s.eps")
  ...
  p[2,0].aspect_ratio = 0.33
  p.aspect_ratio = 1.2
  p.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_final_allfit_comb2.eps")
  ...
  p.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_final_allfit_comb3.eps")
  ...
  p[2,0].y1.range = 0., 15.
  p.aspect_ratio = 1.2
  p.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_final_allfit_comb.eps")
...
#   q[0,2].add(biggles.PlotLabel(0.32, 0.10-0.03, r"$\pm$ 0.006 keV", texthalign="left", fontsize=5.))
  ...
  q.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_three_resonances_inset_squat2.eps")
  ...
  p[2,0].x1.label = r"Center-of-mass energy (2 $\times$ beam energy) in MeV"
  p.aspect_ratio = 1.2
  p.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_allfit.eps")
  ...
  p[2,0].x1.label = r"Center-of-mass energy (2 $\times$ beam energy) in MeV"
  p.aspect_ratio = 1.2
  p.write_eps("/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_allfit_comb.eps")

  def combpull1(area, rmsbeam, back, jan16, jan30, feb06, feb13, feb20, feb27, mar06, mar13, apr03, apr08, apr09, apr10, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac):
    x = []
    y = []
    yerr = []
    adddata2(u1data["cont"], jan16, x, y, yerr)
    adddata2(u1data["high"], jan16, x, y, yerr)
    adddata2(u1data["jan16"], jan16, x, y, yerr)
    adddata2(u1data["jan30"], jan16, x, y, yerr)
    adddata2(u1data["feb06"], jan16, x, y, yerr)
    adddata2(u1data["feb13"], jan16, x, y, yerr)
    adddata2(u1data["feb20"], jan16, x, y, yerr)
    adddata2(u1data["feb27"], jan16, x, y, yerr)
    adddata2(u1data["mar06"], jan16, x, y, yerr)
    adddata2(u1data["mar13"], jan16, x, y, yerr)
    adddata2(u1data["apr03"], jan16, x, y, yerr)
    adddata2(u1data["apr08"], jan16, x, y, yerr)
    adddata2(u1data["apr09"], jan16, x, y, yerr)
    adddata2(u1data["apr10"], jan16, x, y, yerr)
    themap = {}
    for xi, yi, yerri in zip(x, y, yerr):
      if round(xi) not in themap: themap[round(xi)] = []
      themap[round(xi)].append((xi, yi, yerri))
    ...
    pullx = fewx
    pully = map(lambda (en, c, e): (c - u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, en))/e, zip(fewx, fewy, fewyerr))
    p = biggles.FramedPlot()
    p.add(biggles.Points(pullx, pully, symboltype="filled circle", symbolsize=1.5))
    p.add(biggles.LineY(0.))
    p.xrange = 9420., 9580.
    p.yrange = -4, 4
    return p

  def combpull2(area, rmsbeam, back, may29, jun11, jun12, jul10, jul24, aug07, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, p=None, GeV=False):
    x = []
    y = []
    yerr = []
    adddata2(u2data["cont"], may29, x, y, yerr)
    adddata2(u2data["high"], may29, x, y, yerr)
    adddata2(u2data["may29"], may29, x, y, yerr)
    adddata2(u2data["jun11"], may29, x, y, yerr)
    adddata2(u2data["jun12"], may29, x, y, yerr)
    adddata2(u2data["jul10"], may29, x, y, yerr)
    adddata2(u2data["jul24"], may29, x, y, yerr)
    adddata2(u2data["aug07"], may29, x, y, yerr)
    themap = {}
    for xi, yi, yerri in zip(x, y, yerr):
      if round(xi) not in themap: themap[round(xi)] = []
      themap[round(xi)].append((xi, yi, yerri))
    ...
    pullx = fewx
    pully = map(lambda (en, c, e): (c - u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, en))/e, zip(fewx, fewy, fewyerr))
    p = biggles.FramedPlot()
    p.add(biggles.Points(pullx, pully, symboltype="filled circle", symbolsize=1.5))
    p.add(biggles.LineY(0.))
    p.xrange = 9980., 10100.
  ...
  def combpull3(area, rmsbeam, back, nov28, dec05, dec12, dec19, dec26, jan02, jan09, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, p=None, GeV=False):
    x = []
    y = []
    yerr = []
    adddata2(u3data["cont"], nov28, x, y, yerr)
    adddata2(u3data["high"], nov28, x, y, yerr)
    adddata2(u3data["nov28"], nov28, x, y, yerr)
    adddata2(u3data["dec05"], nov28, x, y, yerr)
    adddata2(u3data["dec12"], nov28, x, y, yerr)
    adddata2(u3data["dec19"], nov28, x, y, yerr)
    adddata2(u3data["dec26"], nov28, x, y, yerr)
    adddata2(u3data["jan02"], nov28, x, y, yerr)
    adddata2(u3data["jan09"], nov28, x, y, yerr)
    themap = {}
    for xi, yi, yerri in zip(x, y, yerr):
      if round(xi) not in themap: themap[round(xi)] = []
      themap[round(xi)].append((xi, yi, yerri))
    ...
    pullx = fewx
    pully = map(lambda (en, c, e): (c - u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, en))/e, zip(fewx, fewy, fewyerr))
    p = biggles.FramedPlot()
    p.add(biggles.Points(pullx, pully, symboltype="filled circle", symbolsize=1.5))
    p.add(biggles.LineY(0.))
    p.xrange = 10320., 10420.
  ...
  p = biggles.Table(3,1)
  p[0,0] = combpull1(*fitrecord[1].values)
  p[1,0] = combpull2(*fitrecord[2].values)
  p[2,0] = combpull3(*fitrecord[3].values)
  p[0,0].y1.label = r"$\Upsilon(1S)$ pull"
  p[1,0].y1.label = r"$\Upsilon(2S)$ pull"
  p[2,0].y1.label = r"$\Upsilon(3S)$ pull"
  ...
  if lumisource == 0:
    p.title = r"$\gamma\gamma$ luminosity"
  elif lumisource == 1:
    p.title = r"inner $e^+e^-$ luminosity"
  elif lumisource == 2:
    p.title = r"outer $e^+e^-$ luminosity"
  p.aspect_ratio = 11./8.5
  p.write_eps("/home/mccann/antithesis/plots/bhabhafits_forced_extraplots_pull"+str(lumisource)+".eps")

  def combweek1(area, rmsbeam, back, jan16, jan30, feb06, feb13, feb20, feb27, mar06, mar13, apr03, apr08, apr09, apr10, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac):
    pulls = []
    names = ["jan16", "jan30", "feb06", "feb13", "feb20", "feb27", "mar06", "mar13", "apr03", "apr08", "apr09", "apr10"]
    numbers = [jan16, jan16, jan16, jan16, jan16, jan16, jan16, jan16, jan16, jan16, jan16, jan16]
    def oneweek(name, number):
      x = []
      y = []
      yerr = []
      adddata2(u1data[name], number, x, y, yerr)
      mean, err = jt.wmean(map(lambda (xi, yi, yierr): ((yi - u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, xi)), yierr), zip(x,y,yerr)))
      return mean/err
    for n1, n2 in zip(names, numbers):
      pulls.append(oneweek(n1, n2))

    p = biggles.FramedPlot()
    p.add(biggles.Points(range(len(pulls)), pulls, symboltype="filled circle", symbolsize=1.5))
    p.add(biggles.LineY(0.))
    p.x.draw_subticks = 0
    p.x1.ticks = range(len(pulls))[::2]
    p.x1.ticklabels = names[::2]
    p.x2.ticks = range(len(pulls))[1::2]
    p.x2.ticklabels = names[1::2]
    p.xrange = -1, len(pulls)
    p.yrange = -4, 4
    return p

  def combweek2(area, rmsbeam, back, may29, jun11, jun12, jul10, jul24, aug07, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area):
    pulls = []
    names = ["may29", "jun11", "jun12", "jul10", "jul24", "aug07"]
    numbers = [may29, may29, may29, may29, may29, may29]
    def oneweek(name, number):
      x = []
      y = []
      yerr = []
      adddata2(u2data[name], number, x, y, yerr)
      mean, err = jt.wmean(map(lambda (xi, yi, yierr): ((yi - u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, xi)), yierr), zip(x,y,yerr)))
      return mean/err
    for n1, n2 in zip(names, numbers):
      pulls.append(oneweek(n1, n2))
    ...
    p.add(biggles.Points(range(len(pulls)), pulls, symboltype="filled circle", symbolsize=1.5))
    p.add(biggles.LineY(0.))
    p.x1.ticks = range(len(pulls))
    p.x1.ticklabels = names
    p.x.draw_subticks = 0
    p.x2.draw_ticks = 0
    p.xrange = -1, len(pulls)
    p.yrange = -4, 4
  ...
  def combweek3(area, rmsbeam, back, nov28, dec05, dec12, dec19, dec26, jan02, jan09, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area):
    pulls = []
    names = ["nov28", "dec05", "dec12", "dec19", "dec26", "jan02", "jan09"]
    numbers = [nov28, nov28, nov28, nov28, nov28, nov28, nov28]
    def oneweek(name, number):
      x = []
      y = []
      yerr = []
      adddata2(u3data[name], number, x, y, yerr)
      mean, err = jt.wmean(map(lambda (xi, yi, yierr): ((yi - u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, xi)), yierr), zip(x,y,yerr)))
      return mean/err
    for n1, n2 in zip(names, numbers):
      pulls.append(oneweek(n1, n2))
  ...
  p = biggles.Table(3,1)
  p[0,0] = combweek1(*fitrecord[1].values)
  p[1,0] = combweek2(*fitrecord[2].values)
  p[2,0] = combweek3(*fitrecord[3].values)
  p[0,0].y1.label = r"$\Upsilon(1S)$ pull"
  p[1,0].y1.label = r"$\Upsilon(2S)$ pull"
  p[2,0].y1.label = r"$\Upsilon(3S)$ pull"
  p[0,0].x1.label = r"Scan label"
  p[1,0].x1.label = r"Scan label"
  p[2,0].x1.label = r"Scan label"
  if lumisource == 0:
    p.title = r"$\gamma\gamma$ luminosity"
  elif lumisource == 1:
    p.title = r"inner $e^+e^-$ luminosity"
    ...
    p.title = r"outer $e^+e^-$ luminosity"
  p.aspect_ratio = 11./8.5
  p.write_eps("/home/mccann/antithesis/plots/bhabhafits_forced_extraplots_weeks"+str(lumisource)+".eps")

print "from gamgams"
doitall(0)
print "from inner bhabhas"
doitall(1)
print "from outer bhabhas"
doitall(2)

# Look at all the plots I made!
# 
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_allfit_comb.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_allfit.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_final_allfit_comb2.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_final_allfit_comb3.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_final_allfit_comb.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual0.7_noinset_1s.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual0.7_noinset_2s.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual0.7_noinset_3s.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual0.7_withinset_1s.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual0.7_withinset_2s.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual0.7_withinset_3s.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual_noinset_1s.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual_noinset_2s.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual_noinset_3s.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual_withinset_1s.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual_withinset_2s.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_individual_withinset_3s.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_pulls1again.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_pulls1.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_pulls2again.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_pulls2.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_pulls3again.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_pulls3.eps")
# "/home/mccann/antithesis/fit_results/bhabhafits_forced_"+str(lumisource)+"_three_resonances_inset_squat2.eps")
