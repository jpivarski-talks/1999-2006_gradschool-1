...
def doitall(lumisource, bhabha_interference):
  ...
  u1fitter.values = [325.3, 3.79, 9.35, 0.33, 0.48, -0.07, -0.02, -0.03, 0.15, 0.35, 0.25, 0.79, 0.56, 0.54, 0.71, 0.053, 0.01864, 0.0, 0.0249, 0.19543, 0.0, 0.0792, 3.82, 3.81, 3.72, 3.73]
...
#   u3fitter.values = [3.58 * nbish2nb, 4.48, 0.404 * nbish2nb, -2.12, -3.99, -3.18, -2.46, -2.72, -2.55, -2.64, 0.0263, 0.01823, 0., 0.0239, 0.27, 0., 0.0792, u1fitter.values[0], u2fitter.values[0], 4.48, 4.48, 4.48, 4.48, 4.48, 4.48, 4.48]
  ...
  pickle.dump(fitrecord, open("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+".p", 'w'))
  ...
  extraarea = 4.
  u1plot_pull(*fitrecord[1].values).write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls1.eps")
  ...
  for y in (2001, 2002):
    for d in Numeric.array(range(365))+1:
        dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
  extraarea = 1.
  u1plot_pull_again(*fitrecord[1].values).write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls1again.eps")
  ...
  for y in (2001, 2002):
    for d in Numeric.array(range(365))+1:
      if d % 7 == 0:
        dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
  extraarea = 4.
  u2plot_pull(*fitrecord[2].values).write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls2.eps")
  ...
  for y in (2001, 2002):
    for d in Numeric.array(range(365))+1:
        dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
  extraarea = 1.
  u2plot_pull_again(*fitrecord[2].values).write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls2again.eps")
  ...
  for y in (2001, 2002):
    for d in Numeric.array(range(365))+1:
      if d % 7 == 0:
        dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
  extraarea = 4.
  u3plot_pull(*fitrecord[3].values).write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls3.eps")
  ...
  for y in (2001, 2002):
    for d in Numeric.array(range(365))+1:
        dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
  extraarea = 1.
  u3plot_pull_again(*fitrecord[3].values).write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls3again.eps")
  ...
  p1.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_1s.eps")
  p2.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_2s.eps")
  p3.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_3s.eps")
  ...
  p1.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_1s.eps")
  p2.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_2s.eps")
  p3.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_3s.eps")
  ...
  p1.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_1s.eps")
  p2.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_2s.eps")
  p3.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_3s.eps")
  ...
  p1.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_1s.eps")
  p2.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_2s.eps")
  p3.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_3s.eps")
  ...
  p[2,0].aspect_ratio = 0.33
  p.aspect_ratio = 1.2
  p.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb2.eps")
  ...
  p.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb3.eps")
  ...
  p[2,0].y1.range = 0., 15.
  p.aspect_ratio = 1.2
  p.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb.eps")
...
#   q[0,2].add(biggles.PlotLabel(0.32, 0.10-0.03, r"$\pm$ 0.006 keV", texthalign="left", fontsize=5.))
  ...
  q.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_three_resonances_inset_squat2.eps")
  ...
  p[2,0].x1.label = r"Center-of-mass energy (2 $\times$ beam energy) in MeV"
  p.aspect_ratio = 1.2
  p.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_allfit.eps")
  ...
  p[2,0].x1.label = r"Center-of-mass energy (2 $\times$ beam energy) in MeV"
  p.aspect_ratio = 1.2
  p.write_eps("/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_allfit_comb.eps")
...
# 
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_allfit_comb.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_allfit.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb2.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb3.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_1s.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_2s.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_3s.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_1s.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_2s.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_3s.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_1s.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_2s.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_3s.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_1s.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_2s.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_3s.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls1again.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls1.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls2again.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls2.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls3again.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls3.eps")
# "/home/mccann/antithesis/fit_results/novemberfits_lastever_"+str(lumisource)+"_"+str(bhabha_interference)+"_three_resonances_inset_squat2.eps")
