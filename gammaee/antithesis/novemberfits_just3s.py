...
class FitRecord: pass
fitrecord = pickle.load(open("/home/mccann/antithesis/fit_results/first_november/novemberfits_"+str(lumisource)+"_"+str(bhabha_interference)+".p"))
...
u3fitter.values = [86.11, 4.48, 9.315, -2.12, -3.99, -3.18, -2.46, -2.72, -2.55, -2.64, 0.0263, 0.01823, 0., 0.0239, 0.27, 0., 0.0792, fitrecord[1].values[0], fitrecord[2].values[0], 4.72, 4.72, 4.72, 4.72, 4.72, 4.72, 4.72]
...
u3fitter.values = [93.0, 4.9, 9.315, -2.12-0.5, -3.99-0.5, -3.18-0.5, -2.46-0.5, -2.72-0.5, -2.55-0.5, -2.64-0.5, 0.0263, 0.01823, 0., 0.0239, 0.27, 0., 0.0792, fitrecord[1].values[0], fitrecord[2].values[0], 4.9, 4.9, 4.9, 4.9, 4.9, 4.9, 4.9]
# u3fitter.values = [86.11, 4.48, 9.315, 4.725, 4.463, 4.527, 4.696, 4.120, 4.579, 4.607, 0.0263, 0.01823, 0., 0.0239, 0.27, 0., 0.0792, fitrecord[1].values[0], fitrecord[2].values[0], -2.426, -4.224, -3.242, -2.218, -3.028, -2.736, -2.480]
#   u3fitter.values = [3.58 * nbish2nb, 4.48, 0.404 * nbish2nb, -2.12, -3.99, -3.18, -2.46, -2.72, -2.55, -2.64, 0.0263, 0.01823, 0., 0.0239, 0.27, 0., 0.0792, u1fitter.values[0], u2fitter.values[0], 4.48, 4.48, 4.48, 4.48, 4.48, 4.48, 4.48]
...
# fval = 153.884352359, edm = 6.76023667237e-07, ncalls = 483

#     area = 89.4949371422 +/- 0.887739668905, no limits
#     rmsbeam = 4.68175358515 +/- 0.1, no limits
#     back = 9.31535645621 +/- 0.0114980867927, no limits
#     nov28 = -3.36475422397 +/- 0.150080302715, no limits
#     dec05 = -3.95717183504 +/- 0.126475423051, no limits
#     dec12 = -2.8544606377 +/- 0.158716506756, no limits
#     dec19 = -2.7372247751 +/- 0.165752632553, no limits
#     dec26 = -2.73806071112 +/- 0.105772756938, no limits
#     jan02 = -2.89938307823 +/- 0.126103907426, no limits
#     jan09 = -2.9877928854 +/- 0.11503699319, no limits
#     fullgam = 0.0263 +/- 0.1, no limits
#     yint = 0.01823 +/- 0.1, no limits
#     phi = 0.0 +/- 0.1, no limits
#     btautau = 0.0239 +/- 0.1, no limits
#     tauyint = 0.27 +/- 0.1, no limits
#     tauphi = 0.0 +/- 0.1, no limits
#     twophofrac = 0.0792 +/- 0.1, no limits
#     u1area = 325.289556395 +/- 0.1, no limits
#     u2area = 134.140808672 +/- 0.1, no limits
#     rnov28 = 4.66393480535 +/- 0.0652635714598, no limits
#     rdec05 = 4.69231589804 +/- 0.0634885932437, no limits
#     rdec12 = 4.68382496175 +/- 0.0589729827967, no limits
#     rdec19 = 4.74848527548 +/- 0.0726006382925, no limits
#     rdec26 = 4.79907945567 +/- 0.105825135378, no limits
#     rjan02 = 4.51511681988 +/- 0.0666188708526, no limits
#     rjan09 = 4.67565021247 +/- 0.0553553843716, no limits
...
pickle.dump(fitrecord, open("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+".p", 'w'))
...
extraarea = 4.
u1plot_pull(*fitrecord[1].values).write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls1.eps")
...
for y in (2001, 2002):
  for d in Numeric.array(range(365))+1:
      dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
extraarea = 1.
u1plot_pull_again(*fitrecord[1].values).write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls1again.eps")
...
for y in (2001, 2002):
  for d in Numeric.array(range(365))+1:
    if d % 7 == 0:
      dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
extraarea = 4.
u2plot_pull(*fitrecord[2].values).write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls2.eps")
...
for y in (2001, 2002):
  for d in Numeric.array(range(365))+1:
      dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
extraarea = 1.
u2plot_pull_again(*fitrecord[2].values).write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls2again.eps")
...
for y in (2001, 2002):
  for d in Numeric.array(range(365))+1:
    if d % 7 == 0:
      dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
extraarea = 4.
u3plot_pull(*fitrecord[3].values).write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls3.eps")
...
for y in (2001, 2002):
  for d in Numeric.array(range(365))+1:
      dsubticks.append(time.mktime(time.strptime("%03d %4d" % (d, y), "%j %Y")))
extraarea = 1.
u3plot_pull_again(*fitrecord[3].values).write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_pulls3again.eps")
...
p1.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_1s.eps")
p2.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_2s.eps")
p3.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_noinset_3s.eps")
...
p1.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_1s.eps")
p2.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_2s.eps")
p3.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual_withinset_3s.eps")
...
p1.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_1s.eps")
p2.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_2s.eps")
p3.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_noinset_3s.eps")
...
p1.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_1s.eps")
p2.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_2s.eps")
p3.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_individual0.7_withinset_3s.eps")
...
p[2,0].aspect_ratio = 0.33
p.aspect_ratio = 1.2
p.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb2.eps")
...
p.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb3.eps")
...
p[2,0].y1.range = 0., 15.
p.aspect_ratio = 1.2
p.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_final_allfit_comb.eps")
...
q.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_three_resonances_inset_squat2.eps")
...
p[2,0].x1.label = r"Center-of-mass energy (2 $\times$ beam energy) in MeV"
p.aspect_ratio = 1.2
p.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_allfit.eps")
...
p[2,0].x1.label = r"Center-of-mass energy (2 $\times$ beam energy) in MeV"
p.aspect_ratio = 1.2
p.write_eps("/home/mccann/antithesis/fit_results/novemberfits_just3s_"+str(lumisource)+"_"+str(bhabha_interference)+"_allfit_comb.eps")
