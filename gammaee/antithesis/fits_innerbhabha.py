...
pickle.dump(fitrecord, open("/home/mccann/antithesis/fit_results/innerbhabha.p", 'w'))

# u1plot(*u1fitter.values).show()
u1plot(*u1fitter.values).write_eps("/home/mccann/antithesis/fit_results/innerbhabha_1fit.eps")

# u2plot(*u2fitter.values).show()
u2plot(*u2fitter.values).write_eps("/home/mccann/antithesis/fit_results/innerbhabha_2fit.eps")

# u3plot(*u3fitter.values).show()
u3plot(*u3fitter.values).write_eps("/home/mccann/antithesis/fit_results/innerbhabha_3fit.eps")
...
def u1plot_pull(area, rmsbeam, back, jan16, jan30, feb06, feb13, feb20, feb27, mar06, mar13, apr03, apr08, apr09, apr10, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac):
  ...
  adddata_pull2(p[2,0], u1runs["jan16"], u1data["jan16"], jan16, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  adddata_pull2(p[2,0], u1runs["jan30"], u1data["jan30"], jan30, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  adddata_pull2(p[2,0], u1runs["feb06"], u1data["feb06"], feb06, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  adddata_pull2(p[2,0], u1runs["feb13"], u1data["feb13"], feb13, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  adddata_pull2(p[2,0], u1runs["feb20"], u1data["feb20"], feb20, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  adddata_pull2(p[2,0], u1runs["feb27"], u1data["feb27"], feb27, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  adddata_pull2(p[2,0], u1runs["mar06"], u1data["mar06"], mar06, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  adddata_pull2(p[2,0], u1runs["mar13"], u1data["mar13"], mar13, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  adddata_pull2(p[2,0], u1runs["apr03"], u1data["apr03"], apr03, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  adddata_pull2(p[2,0], u1runs["apr08"], u1data["apr08"], apr08, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  adddata_pull2(p[2,0], u1runs["apr09"], u1data["apr09"], apr09, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  adddata_pull2(p[2,0], u1runs["apr10"], u1data["apr10"], apr10, lambda w: u1func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, w))
  p[2,0].add(biggles.LineY(0.))
  p[2,0].x1.range = 123000, 125500
  p[2,0].x1.label = r"Run Number"
  ...
  p[0,0].aspect_ratio = 0.4
  p[1,0].aspect_ratio = 0.4
  p[2,0].aspect_ratio = 0.4
  p[1,0], p[2,0] = p[2,0], p[1,0]
  p.aspect_ratio = 1.2
  return p
# u1plot_pull(*u1fitter.values).show()
u1plot_pull(*u1fitter.values).write_eps("/home/mccann/antithesis/fit_results/innerbhabha_1pull.eps")
...
def u2plot_pull(area, rmsbeam, back, may29, jun11, jun12, jul10, jul24, aug07, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area):
  ...
  adddata_pull2(p[2,0], u2runs["may29"], u2data["may29"], may29, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
  adddata_pull2(p[2,0], u2runs["jun11"], u2data["jun11"], jun11, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
  adddata_pull2(p[2,0], u2runs["jun12"], u2data["jun12"], jun12, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
  adddata_pull2(p[2,0], u2runs["jul10"], u2data["jul10"], jul10, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
  adddata_pull2(p[2,0], u2runs["jul24"], u2data["jul24"], jul24, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
  adddata_pull2(p[2,0], u2runs["aug07"], u2data["aug07"], aug07, lambda w: u2func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, w))
  p[2,0].add(biggles.LineY(0.))
...
u2plot_pull(*u2fitter.values).write_eps("/home/mccann/antithesis/fit_results/innerbhabha_2pull.eps")
...
def u3plot_pull(area, rmsbeam, back, nov28, dec05, dec12, dec19, dec26, jan02, jan09, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area):
  ...
  adddata_pull2(p[2,0], u3runs["nov28"], u3data["nov28"], nov28, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
  adddata_pull2(p[2,0], u3runs["dec05"], u3data["dec05"], dec05, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
  adddata_pull2(p[2,0], u3runs["dec12"], u3data["dec12"], dec12, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
  adddata_pull2(p[2,0], u3runs["dec19"], u3data["dec19"], dec19, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
  adddata_pull2(p[2,0], u3runs["dec26"], u3data["dec26"], dec26, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
  adddata_pull2(p[2,0], u3runs["jan02"], u3data["jan02"], jan02, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
  adddata_pull2(p[2,0], u3runs["jan09"], u3data["jan09"], jan09, lambda w: u3func(area, rmsbeam, back, fullgam, yint, phi, btautau, tauyint, tauphi, twophofrac, u1area, u2area, w))
  p[2,0].add(biggles.LineY(0.))
...
u3plot_pull(*u3fitter.values).write_eps("/home/mccann/antithesis/fit_results/innerbhabha_3pull.eps")
