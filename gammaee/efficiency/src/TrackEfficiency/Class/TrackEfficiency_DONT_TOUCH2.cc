...
// Module:      TrackEfficiency_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor TrackEfficiency:
//              creates a new TrackEfficiency instance each time 
