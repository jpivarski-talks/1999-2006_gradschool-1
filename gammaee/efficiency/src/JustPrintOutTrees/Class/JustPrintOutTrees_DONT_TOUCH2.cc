...
// Module:      JustPrintOutTrees_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor JustPrintOutTrees:
//              creates a new JustPrintOutTrees instance each time 
