...
file add binchain electrons1.bin event startrun beginrun endrun
file add binchain electrons2.bin event startrun beginrun endrun
file add binchain electrons3.bin event startrun beginrun endrun
file add binchain electrons4.bin event startrun beginrun endrun

sink_format sel PDSSinkFormat
file sink ../rzn/electrons.pds event startrun beginrun endrun
