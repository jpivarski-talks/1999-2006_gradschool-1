...
file add binchain positrons1.bin event startrun beginrun endrun
file add binchain positrons2.bin event startrun beginrun endrun

sink_format sel PDSSinkFormat
file sink ../rzn/positrons2.pds event startrun beginrun endrun
