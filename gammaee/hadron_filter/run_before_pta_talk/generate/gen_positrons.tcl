...
file add binchain sb_binaries/positrons1.bin event startrun beginrun endrun
file add binchain sb_binaries/positrons2.bin event startrun beginrun endrun

sink_format sel PDSSinkFormat
file sink $env(USER_TMP)/new_positrons.pds event startrun beginrun endrun
