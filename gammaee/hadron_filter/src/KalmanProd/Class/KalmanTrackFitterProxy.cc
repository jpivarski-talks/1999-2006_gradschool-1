...
// $Id: KalmanTrackFitterProxy.cc,v 1.15 2002/02/22 03:33:57 wsun Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: KalmanTrackFitterProxy.cc,v 1.15 2002/02/22 03:33:57 wsun Exp $";
