...
// $Id: LatticeLinkTrkmanLatticeStorageHelper.cc,v 1.4 2001/01/31 22:16:03 cdj Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: LatticeLinkTrkmanLatticeStorageHelper.cc,v 1.4 2001/01/31 22:16:03 cdj Exp $";
