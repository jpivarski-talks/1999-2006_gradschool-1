...
// Module:      TmpFilterProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor TmpFilterProc:
//              creates a new TmpFilterProc instance each time 
