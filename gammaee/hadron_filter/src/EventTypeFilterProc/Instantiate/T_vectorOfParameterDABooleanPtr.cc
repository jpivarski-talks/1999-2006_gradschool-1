...
// $Id: T_vectorOfParameterDABooleanPtr.cc,v 1.1.1.1 2001/07/31 18:14:14 bkh Exp $
//
// Revision history
//
// $Log: T_vectorOfParameterDABooleanPtr.cc,v $
...
typedef Parameter<DABoolean>*  _vector_contents_;
