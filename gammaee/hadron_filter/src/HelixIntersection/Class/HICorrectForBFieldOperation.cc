...
// $Id: HICorrectForBFieldOperation.cc,v 1.3 2002/02/18 23:00:21 wsun Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: HICorrectForBFieldOperation.cc,v 1.3 2002/02/18 23:00:21 wsun Exp $";
