...
// Module:      CosmicBGBWCounter_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor CosmicBGBWCounter:
//              creates a new CosmicBGBWCounter instance each time 
