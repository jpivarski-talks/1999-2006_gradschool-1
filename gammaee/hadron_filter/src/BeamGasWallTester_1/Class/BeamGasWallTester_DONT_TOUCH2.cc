...
// Module:      BeamGasWallTester_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor BeamGasWallTester:
//              creates a new BeamGasWallTester instance each time 
