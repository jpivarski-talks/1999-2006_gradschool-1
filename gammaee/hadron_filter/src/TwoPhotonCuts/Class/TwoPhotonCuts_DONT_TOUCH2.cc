...
// Module:      TwoPhotonCuts_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor TwoPhotonCuts:
//              creates a new TwoPhotonCuts instance each time 
