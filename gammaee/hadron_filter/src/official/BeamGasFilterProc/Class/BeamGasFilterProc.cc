...
// $Id: BeamGasFilterProc.cc,v 1.1 2002/10/31 21:44:09 mccann Exp $
//
// Revision history
//
...
static const char* const kIdString  = "$Id: BeamGasFilterProc.cc,v 1.1 2002/10/31 21:44:09 mccann Exp $";
...
BeamGasFilterProc::event( Frame& iFrame )          // anal3 equiv.
{
   ...
   DABoolean passed_weighted_z( abs( weighted_z - m_beam_z ) < m_weightedZCut.value() );
