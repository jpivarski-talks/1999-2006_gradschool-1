...
// Module:      ChargeDistributionsProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor ChargeDistributionsProc:
//              creates a new ChargeDistributionsProc instance each time 
...
makeProcessor( void )
{
   return new ChargeDistributionsProc;
}
